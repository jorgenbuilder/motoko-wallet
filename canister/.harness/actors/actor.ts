...
import { idlFactory } from './interface/motoko-wallet/motoko-wallet.did'
import { _SERVICE } from './interface/motoko-wallet/motoko-wallet.did.d'
...
export function motokoWalletActor (identity?: Identity) : ActorSubclass<_SERVICE> {
    return createActor(canisters['motoko-wallet'].local, idlFactory, { identity });
};